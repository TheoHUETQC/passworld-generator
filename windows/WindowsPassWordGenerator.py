...
def generate_password():
    ...
    global generated_pw
    generated_pw = new_pw[:MDP_SIZE]  # Mot de passe généré

    # Afficher le mot de passe masqué sous forme d'astérisques
    label_resultat.config(text="Your Password : " + "*" * MDP_SIZE)
...
btn_copier = tk.Button(frame_buttons, text="Copy", command=copy_password, font=("Helvetica", 12), bg="#d3d3d3", fg="white", relief="flat", bd=0, padx=10, pady=5, highlightthickness=0, state="disabled")
